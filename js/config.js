...
const BASE_CONFIG = {
  ...
  REGION_COORDS: Object.freeze({
    '서울': {lat:37.5665,lng:126.9780,zoom:13},
    ...
    '속초': {lat:38.2070,lng:128.5918,zoom:13},
    '사용자 등록': {lat:37.5665,lng:126.9780,zoom:12},
  }),
  ...
  REGION_EN: Object.freeze({
    '서울':'Seoul,KR','부산':'Busan,KR','제주':'Jeju,KR',
    '경주':'Gyeongju,KR','강릉':'Gangneung,KR','전주':'Jeonju,KR',
    '수원':'Suwon,KR','인천':'Incheon,KR','여수':'Yeosu,KR','속초':'Sokcho,KR',
  }),

  // 🎨 UI 요소
  THEME_EMOJI: Object.freeze({
    '먹방':'🍜','힐링':'🌿','문화':'🏛️','액티비티':'🏄',
    '카페투어':'☕','쇼핑':'🛍️','야경':'🌙','자연':'🏔️','커스텀':'📎',
  }),

  MARKER_COLORS: ['#c4a360','#d4b472','#e8ca90','#a07840','#7a5c30'],

  RATING_LABELS: Object.freeze({
    1:'별로예요',2:'아쉬워요',3:'괜찮아요',4:'좋아요',5:'최고예요!'
  }),
